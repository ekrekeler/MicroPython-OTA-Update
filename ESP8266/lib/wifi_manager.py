...
class WifiManager:
    ...
    def __init__(self, ssid = 'WifiManager', password = 'wifimanager'):
        ...
        self.ap_authmode = 3 if password else 0
    ...
    def __WebServer(self):
        ...
        password_info = 'with the password ' + self.ap_password if self.ap_password else ''
        print('Connect to', self.ap_ssid, password_info, 'and access the captive portal at', self.wlan_ap.ifconfig()[0])
        while True:
            if self.wlan_sta.isconnected():
